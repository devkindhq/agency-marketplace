---
name: tech-detector
description: Detect the technology stack of any website for sales prospecting. Use when someone shares a prospect URL, asks "what are they running", "what's their stack", or wants to research a client/competitor. Runs WhatWeb scan and returns sales-relevant insights and pitch angles.
tools: [mcp__plugin_security_whatweb__whatweb_scan]
---

# Tech Detector — Sales Prospecting
...
- "Can we pitch [company]?" + a URL is provided
...
- `aggression`: `normal` (default — non-intrusive, safe for prospects)
...
### 2. What This Tells Us (Sales Intelligence)
